...
function updateCanvas() {
  ...
  if (completedGame) {
    ...
    ctx.font = TEXT_FONT
    //ctx.drawImage(marsImage, marsXPosition, marsYPosition, WIDTH, HEIGHT)
    ctx.drawImage(marsImage, marsXPosition, marsYPosition, MARS_WIDTH, MARS_HEIGHT)
    ctx.fillText("YOU LAND ON MARS! o((>ω< ))o", textXPosition, textYPosition)
  ...
  var expiry = 420
  var turningWidth = 8
  if (moveLeftTime + expiry > currentTime && !completedGame) {
