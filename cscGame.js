...
//coin variables
var coinArray = []
var coinXPosition = Math.random()*600
var coinYPosition
...
function updateCanvas (){
	...
	//move clouds
	var cloudNumber = 0
	while (cloudNumber < cloudArray.length){
	...
	var cloudNumber = 0
	while (cloudNumber < cloudArray.length){
		if (balloonHit (cloudArray[cloudNumber].xPosition, cloudArray[cloudNumber].yPosition)){
...
function balloonHit (cloudX, cloudY){
	...
	var balloonHitRight = balloonXPosition + balloonWidth
	var balloonHitTop = balloonYPosition
	var balloonHitBottom = balloonYPosition + balloonHeight
